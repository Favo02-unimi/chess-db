...
<head>
    ...
    <title>ChessDB - Edit profile</title>
        ...
        <div class="flex editProfile">
            ...
            <form action="editProfilePHP.php" method="post">
                ...
                <?php
                    ...
                    if (isset($_SESSION["editProfile_error"])) {
                        echo "
                        <div id='error'>
                        <h2>Failed registration:</h2>
                        <h4>". $_SESSION["editProfile_error"] ."</h4>
                        </div><br>";
                    }
                ?>
                ...
                <div class="tooltip"><i class="fas fa-info-circle"></i>
                    <span class="tooltiptext">2-20 characters, only letters</span>
                </div>
                <input type="text" name="name" placeholder="Your name" pattern="^[a-zA-Z]{2,20}" required>
                <br><br>
                ...
                <input type="text" name="surname" placeholder="Your surname" pattern="^[a-zA-Z]{2,20}" required>
                <br><br>

                <label for="date">New birth date</label>
                <div class="tooltip"><i class="fas fa-info-circle"></i>
                    <span class="tooltiptext">Your birth date</span>
                </div>
                ...
                <div class="tooltip"><i class="fas fa-info-circle"></i>
                    <span class="tooltiptext">A valid email</span>
                </div>
                ...
                <div class="tooltip"><i class="fas fa-info-circle"></i>
                    <span class="tooltiptext">The same password filled above</span>
                </div>
                <input type="password" name="password2" placeholder="Your password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,20}$" required>
                <br><br>

                <input type="submit" value="Edit profile" name="submit">
                <br><br>

                <h3>Missclick? <a href="account.php">Go back!</a></h3>
            </form>
